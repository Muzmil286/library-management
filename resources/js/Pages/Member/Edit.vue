<template>
  <Form :form-heading="`Add a new Member!`">
    <form @submit.prevent="form.put(`/members/${member.id}`)">
...
let form = useForm({
  firstName: usePage().props.member.firstName,
  lastName: usePage().props.member.lastName,
  age: usePage().props.member.age,
  address: usePage().props.member.address,
  phone: usePage().props.member.phone,
  cnic: usePage().props.member.cnic,
  email: usePage().props.member.email,
})
</script>
